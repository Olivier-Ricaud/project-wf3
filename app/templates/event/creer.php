	...
	<div class="row">
		...
		<form class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2" method="POST" >
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="titre" name="form_event[titre]" placeholder="...">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-xs-5 col-sm-6">
					<input type="date" class="form-control" id="date" name="form_event[date]" placeholder="...">
				</div>

				<label for="time" class="col-xs-1 col-form-label">Heure</label>
				<div class="col-xs-3 col-sm-2">
					<input type="time" class="form-control" id="time" name="form_event[heure]" placeholder="...">
				</div>
			</div> <!-- End row -->
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<textarea type="message" class="form-control" id="description" name="form_event[description]" placeholder="Description de l'événement..." rows="10" maxlength="5000"></textarea>
				</div>
			</div>
			<hr>
			<div class="form-group row">
